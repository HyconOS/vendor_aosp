...
PRODUCT_COPY_FILES += \
    ...
    vendor/aosp/prebuilt/common/etc/permissions/privapp-permissions-custom-system_ext.xml:$(TARGET_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-custom-system_ext.xml
